...
class MapUtilsTest {
    ...
    void editNeighbourShouldAddNeighboursToCountry() {
        ...
        assertTrue(d_mapUtils.d_currTargetMap.getCountryByName("New_Brunswick").
                d_neighbours.contains(
                        d_mapUtils.d_currTargetMap.getCountryByName("N&L-Newfoundland")
                )
        );
        assertTrue(d_mapUtils.d_currTargetMap.getCountryByName("N&L-Newfoundland").
                d_neighbours.contains(
                        d_mapUtils.d_currTargetMap.getCountryByName("New_Brunswick")
                )
        );
        assertTrue(d_mapUtils.d_currTargetMap.getCountryByName("N&L-Labrador").
                d_neighbours.contains(
                        d_mapUtils.d_currTargetMap.getCountryByName("Ontario-South")
                )
        );
        assertTrue(d_mapUtils.d_currTargetMap.getCountryByName("Ontario-South").
                d_neighbours.contains(
                        d_mapUtils.d_currTargetMap.getCountryByName("N&L-Labrador")
                )
        );
    ...
    void editNeighbourShouldRemoveNeighboursFromCountry() {
        ...
        assertFalse(d_mapUtils.d_currTargetMap.getCountryByName("New_Brunswick").
                d_neighbours.contains(
                        d_mapUtils.d_currTargetMap.getCountryByName("Quebec-South")
                )
        );
        assertFalse(d_mapUtils.d_currTargetMap.getCountryByName("Quebec-South").
                d_neighbours.contains(
                        d_mapUtils.d_currTargetMap.getCountryByName("New_Brunswick")
                )
        );
        assertFalse(d_mapUtils.d_currTargetMap.getCountryByName("N&L-Labrador").
                d_neighbours.contains(
                        d_mapUtils.d_currTargetMap.getCountryByName("N&L-Newfoundland")
                )
        );
        assertFalse(d_mapUtils.d_currTargetMap.getCountryByName("N&L-Newfoundland").
                d_neighbours.contains(
                        d_mapUtils.d_currTargetMap.getCountryByName("N&L-Labrador")
                )
        );
