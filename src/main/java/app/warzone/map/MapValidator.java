 ...
 * saving any new map the map will be validated automatically.
 *
 * @author Burhanuddin
 */
...
public class MapValidator {
     ...
     * <p>
     * The map should be a graph of continents and if it is true then the continents
     * must be subgraph of countries. This method will validate whether the map is a
     * graph of continents.
     *
    ...
    public static boolean validateContinents(Map p_map) {
        ...
        for (Continent l_continent : p_map.d_continents) {
            ...
            for (Country l_country : l_continent.d_memberCountries) {
                if (!validateCountry(l_country))
                    return false;
            }

            if (!isContinentConnectedGraph(l_continent)) {
                d_alertMsg = "The Continent:- " + l_continent.getContinentName()
                        + " is not connected by its neighbouring countries.A Continent must be connected graph formed by its neighbouring countries in the map.";
                return false;
            }
        }
    ...
    /**
     * This method is used for validating that whether the continents are connected
     * or not.
     *
    ...
    public static boolean isContinentConnectedGraph(Continent p_continent) {
        ...
        for (Country l_country : p_continent.d_memberCountries) {
            if (!l_country.d_isProcessed) {
                d_alertMsg = l_country.d_countryName + "country is not forming connected graph in the continent"
                        + p_continent.d_continentName + ".";
                l_returnValue = false;
                break;
            }
        }
    ...
    /**
     * This method is used for verifying that the subgraph of the continent is
     * connected.
     *
    ...
    /**
     * This is the BFS traversal method for the verification of subgraph
    ...
    /**
     * This method is used to validate that whether the continents in the map form a
     * graph or not.
     *
    ...
    /**
     * This method is used to return the adjacent continents as a list for any
     * particular continent.
     *
     * @param p_continent refers to the continent whose adjacent continents are to
     *                    be found.
     * @param p_map       refers to the map object.
    ...
    /**
     * This method is used to check whether the country belongs to only one
     * continent or not.
     *
