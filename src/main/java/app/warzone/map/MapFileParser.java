...
/**
 * The MapFileParser class parses a Warzone map file and constructs a map based on its contents.
 * @author Burhanuddin
 */
public class MapFileParser {
    ...
    /**
     * Helper for extracting lines from the given file text that fall between the specified start and end markers
     * for the sections.
     *
    ...
    /**
     * Helper to parse the continents section of the map file and adds continents to the parsed map.
     *
    ...
    /**
     * Helper to parse the countries section of the map file and adds countries to the parsed map.
     *
     * @param p_fileText The file text.
     */
    void parseCountries(StringBuilder p_fileText) {
        ...
        for (String l_countryInfo : l_countryLines) {
            ...
            if (l_infoTokens.length < 3) continue;
    ...
    /**
     * Helper to parse the connections section of the map file and establishes connections between countries in the parsed map.
     *
     * @param p_fileText The file text.
     */
    void parseConnections(StringBuilder p_fileText) {
        ...
        for (String l_connectionInfo : l_connectionLines) {
            ...
            if (l_infoTokens.length < 2) continue;
    ...
    /**
     * Parses the entire map file and constructs a map based on its contents using the helper functions above.
     *
